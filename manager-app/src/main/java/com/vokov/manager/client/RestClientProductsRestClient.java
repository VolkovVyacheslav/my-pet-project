package com.vokov.manager.client;

import com.vokov.manager.controller.payload.NewProductPayload;
...
public class RestClientProductsRestClient implements ProductsRestClient {
    ...
    public Optional<Product> findProduct(int productId) {
        try {
            return Optional.ofNullable(this.restClient.get()
                    ...
                    .retrieve()
                    .body(Product.class));
        }catch (HttpClientErrorException.NotFound exceptoin) {
    ...
    public void deleteProduct(int productId) {
        try {
            ...
            throw new NoSuchElementException(exceptoin);
        }
    }
}
